...
return new class extends Migration
{
  ...
  Schema::create('plq_barbers', function(Blueprint $t){
    ...
    $t->string('photo_url')->nullable(); $t->boolean('active')->default(true); $t->timestamps();
  });
  ...
  Schema::create('plq_barber_schedules', function(Blueprint $t){
    ...
    $t->unsignedTinyInteger('weekday'); $t->string('start_time'); $t->string('end_time'); $t->timestamps();
  });
